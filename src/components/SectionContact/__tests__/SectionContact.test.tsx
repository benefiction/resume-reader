...
const mockProfileListComponent = jestMockedComponent(mockProfileListComponentString);
...
describe('<SectionContact>', () => {
  it('renders the contact section with common data', () => {
    ...
    const { getByText, queryByTitle } = render(<SectionContact basics={mockprops} />);
  ...
  it('renders the adress with postalCode', () => {
    ...
    const { queryByText } = render(<SectionContact basics={mockprops.basics} />);
    const { address, postalCode, city, countryCode, region } = mockprops.basics.location;
  ...
  it('renders the profile list, if available', () => {
    ...
    const { getByText } = render(<SectionContact basics={mockprops.basics} />);
