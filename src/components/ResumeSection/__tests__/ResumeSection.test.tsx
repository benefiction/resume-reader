...
const mockResumeSectionHeaderComponent = jestMockedComponent(mockComponentTitle);

jest.mock('@/components/ResumeSectionHeader', () => {
  return {
    ResumeSectionHeader: (props: any) => mockResumeSectionHeaderComponent(props),
  };
});
...
describe('<ResumeSection>', () => {
  ...
  it('it contains a headline and the headline gets the right params', () => {
    const { getByText } = render(<ResumeSection title={mockComponentTitle}></ResumeSection>);
